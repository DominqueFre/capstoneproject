...
### Steps for setting up database information
...
- This will show the location of the files, use this ensuring slashes are forward facing and run the following command
...
|Feature|Casual User|New Member/Novice|Seasoned*|Master*|
|---|---|---|---|---|
